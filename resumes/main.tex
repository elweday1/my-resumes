...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item \textbf{Graduation Project:} REDACTED
    \end{highlights}
\end{onecolentry}
...
\begin{twocolentry}{
    ...
    \textbf{Software Engineer Intern}, Google Deepmind -- Zurich, Switzerland \end{twocolentry}

\vspace{0.10 cm}
\begin{onecolentry}
    \begin{highlights}
        \item Working on an internal gemini tool that integrates Google AI infrastructure that facilitates software engineering work with agents.
        \item Developing features, Enhancing testing infrastructure for the Gemini Web App, shipping to milions of users.
        \item Integrating generative AI models to enhance developer productivity and streamline workflows.
    \end{highlights}
\end{onecolentry}
